            ...
            .state('tab.dash', {
                ...
                views: {
                    'pageContent': {
                        ...
                        controller: 'DashCtrl',
                        resolve: {
                            portfolioData: function (portfolioData) {
            ...
            .state('tab.wallets', {
                ...
                views: {
                    'tab-wallets': {
                        ...
                        resolve: {
                            walletsWBalances: function (walletsWithBalance) {
                                return walletsWithBalance.all();
                            },
                        }
                    }
                }
            ...
            .state('tab.walletdetail', {
                ...
                views: {
                    'tab-wallets': {
                        ...
                        resolve: {
                            walletData: function (walletDetails, $stateParams) {
                                return walletDetails($stateParams.walletAddress);
                            },
                        }
                    }
                }
            ...
            .state('tab.currencies', {
                ...
                views: {
                    'tab-currencies': {
                        ...
                        resolve: {
                            currencies: function (currenciesBalancePrice) {
